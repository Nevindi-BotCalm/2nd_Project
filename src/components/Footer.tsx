function Footer() {
  const navLinks = ['Home', 'Ecosystem', 'How To Buy', 'Why Choose', 'Tokenomics', 'Resources'];

  return (
    <footer className="border border-dotted border-cyan-400 bg-black px-8 py-8">
        ...
        <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-start">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 rounded bg-gray-800 px-3 py-1">
          ...
          <div className="flex flex-col gap-6">
            ...
            <nav className="flex flex-wrap gap-4 text-right">
              {navLinks.map((link) => (
                <a key={link} href="#" className="text-sm text-gray-300 hover:text-[#00FF26]">
                  {link}
                </a>
              ))}
            </nav>
